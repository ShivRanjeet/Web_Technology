    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Add New Application</a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           CHRIST (Deemed to be University) <small>Student Details</small>
                        </h1>
                      ...
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="transac.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Rollno" name="rollno">
                            </div>
                            <div class="form-group">
